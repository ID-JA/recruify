...
{
    Task SendInvitationEmailsAsync(string companyName, Guid companyId, Collection<string> invitees, CancellationToken cancellationToken = default);
...
{
    public async Task SendInvitationEmailsAsync(string companyName, Guid companyId, Collection<string> invitees, CancellationToken cancellationToken = default)
    {
        ...
        jobDataMap.Put("companyId", companyId);
