...
namespace FastRecruiter.Infrasructure.Migrations
{
    ...
    [Migration("20221114204230_RemoveAddColumns")]
    partial class RemoveAddColumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FastRecruiter.Domain.Entities.Applicant", b =>
                {
            ...
            modelBuilder.Entity("FastRecruiter.Domain.Entities.Applicant", b =>
                {
                    b.HasOne("FastRecruiter.Domain.Entities.Job", "Job")
                        .WithMany("Applicants")
                        .HasForeignKey("JobId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FastRecruiter.Infrasructure.Identity.ApplicationUser", null)
                        .WithMany()
