   ...
   {products.map((carpet) => (
    ...
    >
      <div className="relative">
        ...
        <div
          onClick={() => {
            ...
            onAddToCart(carpet.id, 1);
          }}
          className={
            "absolute bg-white text-slate-500 hover:bg-slate-200 right-[1rem] bottom- 
            [1rem] p-4 text-xl rounded-full"
          }
        >
          {loading}
        </div>
      ...
      <div className="flex justify-between p-2 py-4">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-yellow-500 flex items- 
           center justify-center h-10 px-5 rounded-lg font-bold ">
